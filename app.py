...
def toggle_choice1(clicks1,country_choice,time_goal,money_goal,money_start):
    if clicks1==0:
        investment_options={}
        switch_graph=False
    else:
...
def toggle_choice2(clicks2,value,hoverData,country_choice,time_goal,money_goal,money_start):
    if clicks2==0:
        switch_graph=False
...
def toggle_choice3(clicks3,sbank,sbill,sbond,sestate,sstock,rbond,restate,rstock,country_choice,time_goal,money_goal,money_start):
    if clicks3==0:
        switch_graph=False
        switch_parameter=False
        switch_error=False
