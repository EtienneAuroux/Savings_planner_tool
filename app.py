...
from support_functions import check_format,user_choice,investment_options,computer_scatter,computer_pie,user_customization
        ...
        html.Div(id='left_column',className='left',children=[
            html.Div(id='left_column_top',className='block inputBlock',children=[
                ...
                html.Div(id='country_question',children=[
                    ...
                    dcc.Dropdown(id='input_country',className='dropdownCountry',options=countryList,placeholder='e.g., Japan, France, ...',optionHeight=35,style={'height':'2vw','display':'inline-block'})
                    ]),
...
def toggle_choice1(clicks1,submit,country_choice,time_goal,money_goal,money_start):
    if clicks1==0:
        ...
        scatter=investment_options(country_choice,money_start,money_goal,time_goal)
        switch_graph=True
...
def toggle_choice2(clicks2,submit,value,hoverData,country_choice,time_goal,money_goal,money_start):
    if clicks2==0:
        ...
        if hoverData is None:
            pie=computer_pie(country_choice,money_start,money_goal,time_goal,risk_choice,0)
        else:
            hover_data = hoverData["points"][0]
            num=hover_data["pointNumber"]
            pie=computer_pie(country_choice,money_start,money_goal,time_goal,risk_choice,int(num))
        scatter,message=computer_scatter(country_choice,money_start,money_goal,time_goal,risk_choice)
...
def toggle_choice3(clicks3,submit,sbank,sbill,sbond,sestate,sstock,rbond,restate,rstock,country_choice,time_goal,money_goal,money_start):
    if clicks3==0:
        ...
        if sum(repartition)>100:
            ...
            bank=sbank
            scatter=user_customization(country_choice,money_start,money_goal,time_goal,rates,bank,repartition)
